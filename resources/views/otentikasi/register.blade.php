                            ...
                            <div class="p-5">
                                <form class="user" method="post" action="">
                                    ...
                                    <div class="form-group mt-5">
                                        <input type="username" name="username" class="form-control form-control-user @error('username') is-invalid @enderror" placeholder="Masukkan Username" value="{{ old('username') }}">
                                        @error('username')
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="level" class="form-control form-control-user @error('level') is-invalid @enderror" placeholder="Masukkan Level" value="{{ old('level') }}">
                                        @error('level')
                                        <div class="invalid-feedback">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $message }}
                                        </div>
